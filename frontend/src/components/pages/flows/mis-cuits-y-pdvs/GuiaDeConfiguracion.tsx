...
export default function GuiaDeConfiguracion() {
  ...
  return (
    <div className="mx-auto space-y-8">
      ...
      <div className="text-center pt-6">
        <button
          onClick={() => router.push("/flows/mis-cuits-pdvs/configurar")}
          className="cursor-pointer inline-flex items-center px-8 py-3 bg-primary text-white hover:bg-primary-dark focus:outline-none focus:ring-2 focus:bg-secondary transition-colors duration-200 shadow-soft text-lg font-medium">
